...
public class Order {
    ...
    public void setArriveString(String arriveString) {
        this.arriveString = arriveString;
    }
    ...
    public Order(String fio, String passport, int phone, String category, long arrive, long leave, String payment, int FK_status) {
    ...
    public Order(int ID, String fio, String passport, int phone, String category, String payment) {
        this.ID=ID;
        this.fio = fio;
        this.passport = passport;
        this.phone = phone;
